...
def show_main_menu(username,password):
    ...
    label = ttk.Label(root, text="Pilih tindakan:")
    label.pack()

    button1 = ttk.Button(root, text="1. Pilih basis data untuk melihat isinya.", command=lambda: process_choice("1", username, password))
    button1.pack()

    button2 = ttk.Button(root, text="2. Tambah basis data baru.", command=lambda: process_choice("2", username, password))
    button2.pack()

    button3 = ttk.Button(root, text="3. Hapus basis data.", command=lambda: process_choice("3", username, password))
    button3.pack()

    button4 = ttk.Button(root, text="4. Tambah data ke tabel.", command=lambda: process_choice("4", username, password))
    button4.pack()

    button5 = ttk.Button(root, text="5. Tampilkan data dari tabel.", command=lambda: process_choice("5", username, password))
    button5.pack()

    button6 = ttk.Button(root, text="6. Ubah nama database.", command=lambda: process_choice("6", username, password))
    button6.pack()

    button7 = ttk.Button(root, text="7. Ubah nama kolom di tabel.", command=lambda: process_choice("7", username, password))
    button7.pack()

    button8 = ttk.Button(root, text="8. Jadikan kolom pertama sebagai primary key.", command=lambda: process_choice("8", username, password))
    button8.pack()

    button9 = ttk.Button(root, text="9. Menyimpan Data yang Sudah Ada.", command=lambda: process_choice("9", username, password))
    button9.pack()

    button10 = ttk.Button(root, text="10. Keluar.", command=lambda: process_choice("10", username, password))
    button10.pack()
...
def process_choice_1(choice,user,password):
    conn = connect_to_mysql(user, password)
    if not conn:
        return
...
def process_choice_3(choice,user,password):
    conn = connect_to_mysql(user, password)
    if not conn:
        return
...
def process_choice_4(choice,user,password):
    conn = connect_to_mysql(user, password)
    if not conn:
        return
...
def process_choice_5(choice,user,password):
    conn = connect_to_mysql(user, password)
    if not conn:
        return
...
def process_choice_6(choice,user,password):
    conn = connect_to_mysql(user, password)
    if not conn:
        return
...
def process_choice_7(choice,user,password):
    conn = connect_to_mysql(user, password)
    if not conn:
        return
...
def process_choice_8(choice,user,password):
    conn = connect_to_mysql(user, password)
    if not conn:
        return
...
def process_choice_9(choice,user,password):
    conn = connect_to_mysql(user, password)
    if not conn:
        return
...
def process_choice_10(choice,user,password):
    conn = connect_to_mysql(user, password)
    if not conn:
        return
